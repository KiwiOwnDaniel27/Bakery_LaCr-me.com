...
import { ProductsData6 } from '../const/data';
...
const Flores = () => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-[url('/assets/fondo-bakery.png')] dark:bg-[url('/assets/fondo-bakery-osc.png')] h-190">
