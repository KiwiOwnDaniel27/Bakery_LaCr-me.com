...
import { DesayunosData1 } from '../const/data';
    ...
    <div className="bg-rose-200 dark:bg-gray-900">
        ...
        className="grid grid-cols-2 sm:grid-cols-2 xl:grid-cols-4 md:grid-cols-3 gap-3
         ...
         container py-16">
          ...
          {DesayunosData1.map((data) => (

          <div className="bg-white bg-[url('/assets/fondo-bakery.png')] dark:bg-[url('/assets/fondo-bakery-osc.png')] bg-contain bg-fixed
...
export default DesayunosProducts;