...
const TopProducts = () => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-rose-200  dark:bg-gray-900 h-170">
        ...
        <div className="text-center md:text-left mb-9 md:ml-26 xl:py-6 py-9 2xl:py-13 ">
          ...
          lg:text-2xl backdrop-blur-lg">
            Detalles recomendados para ti
          </p>

          <h1 className="text-2xl font-bold 2xl:text-5xl dark:text-amber-500 backdrop-blur-lg
          lg:text-2xl md:text-xl">
          El regalo perfecto comienza aquí.
          </h1>

          <p className="text-xs text-gray-700 dark:text-white 2xl:text-3xl xl:text-lg backdrop-blur-lg
          lg:text-lg">
