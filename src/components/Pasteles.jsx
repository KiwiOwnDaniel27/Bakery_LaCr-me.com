...
import { ProductsData4 } from '../const/data';
...
const Pasteles = () => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-[url('/assets/fondo-bakery.png')] dark:bg-[url('/assets/fondo-bakery-osc.png')] h-200">
